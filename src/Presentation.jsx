...
const Presentation = () => (
  <div>
    ...
    <Deck transition={['fade']} transitionDuration={200} progress="bar" theme={theme}>
        ...
        <RowBlock>
          ...
          <Col width="50%">
            ...
            <TechnologyList
              textColor="secondary"
              img={iconWip}
              list={['Swift', 'Elm', 'Ruby', 'Python', 'PHP', 'Java', 'PostgreSQL']}
              WIP
            />
          </Col>
        </RowBlock>
      ...
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        ...
        <Notes>
          ...
          <ol>
            <li>max-len, no-mixed-spaces-and-tabs, keyword-spacing, comma-style...</li>
            <li>
      ...
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        <Notes>
          <Text textColor="secondary">
            Ну как же так? У нас же уже есть правила и менять их в корне не собираемся
          </Text>
        </Notes>
        <Image src={danResist} />
      </Slide>
      ...
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        <Notes>
          <ol>
            ...
            <li>
              Есть правила которые линтер не может поправить (смешивание математических операторов)
            </li>
          </ol>
        </Notes>
        <Heading size={6} textColor="primary" caps>
        ...
        <CodePane textSize={20} lang="javascript" theme="light" source={exampleProblem1} />
        <CodePane textSize={20} lang="javascript" theme="light" source={exampleProblem3} />
      ...
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        ...
        <CodePane textSize={20} lang="javascript" theme="light" source={exampleProblem2} />
        <CodePane textSize={20} lang="javascript" theme="light" source={exampleProblem4} />
        {/* <Image src={commentsProblem} margin="0 0 50px 0" />
      <Image src={mixedOperators} /> */}
      </Slide>
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        ...
        <CodePane textSize={20} lang="javascript" theme="light" source={solutionProblem} />
      </Slide>
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        <Notes>
          <Text textColor="secondary">
            Разрабы сразу бегут в сендбокс доказывать, что претиер ужасен и присылают мне скриншоты
            :D
          </Text>
        </Notes>
        <Heading size={6} textColor="primary" caps>
        ...
        <RowBlock>
          <CodePane textSize={20} lang="javascript" theme="light" source={exampleBadPrettier1} />
          <CodePane textSize={20} lang="javascript" theme="light" source={exampleBadPrettier2} />
        </RowBlock>
      </Slide>
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        <Notes>
          <Text textColor="secondary">
            Если prettier плохо форматирует, значит с вашим кодом что - то не ладное
          </Text>
        </Notes>
        <Heading size={6} textColor="primary" caps>
      ...
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        ...
        <CodePane textSize={23} lang="javascript" theme="light" source={exampleMatrix} />
      </Slide>
      <Slide transition={['fade']} bgColor="secondary" textColor="primary">
        <BlockQuote>
          <Quote textSize={48}>Prettier - форматирование, которое мы заслужили</Quote>
